...
None,
combine(list(combine(list(combine(list(t_cycle(4,V)), list(edge(V)))), list(edge(V)))), list(edge(V))),
combine(list(combine(list(edge(V)), list(t_cycle(5,V)))), list(edge(V))),
combine(list(edge(V)), list(t_cycle(6,V)))
]
...
import pickle
with open("./data/isoclassk3v10_1", "wb") as fp:   #Pickling
